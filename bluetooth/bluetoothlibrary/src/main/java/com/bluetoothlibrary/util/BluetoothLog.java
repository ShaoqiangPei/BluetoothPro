 ...
 * Description:
 *   默认自定义打印是关闭状态，
 *   若要打印，需要提前设置开启打印功能：BluetoothLog.setDebug(true);
 *
 * Created by pei
 * Date: 2019/1/12
 */
public class BluetoothLog {
    ...
    public static void i(String tag, String msg) {
        if (LOG) {
            printLog(formatLog(tag), msg, BluetoothLog.LEVEL_I);
        }
    }
    ...
    public static void d(String tag, String msg) {
        if (LOG) {
            printLog(formatLog(tag), msg, BluetoothLog.LEVEL_D);
        }
    }
    ...
    public static void w(String tag, String msg) {
        if (LOG) {
            printLog(formatLog(tag), msg, BluetoothLog.LEVEL_W);
        }
    }
    ...
    public static void v(String tag, String msg) {
        if (LOG) {
            printLog(formatLog(tag), msg, BluetoothLog.LEVEL_V);
        }
    }
    ...
    public static void e(String tag, String msg) {
        if (LOG) {
            printLog(formatLog(tag), msg, BluetoothLog.LEVEL_E);
        }
    }
...
//        buffer.append(className + ".");
    ...
    private static void printByLogType(String tag, String msg, String type) {
        switch (type) {
            case BluetoothLog.LEVEL_I:
                android.util.Log.i(tag, msg);
                break;
            case BluetoothLog.LEVEL_D:
                android.util.Log.d(tag, msg);
                break;
            case BluetoothLog.LEVEL_W:
                android.util.Log.w(tag, msg);
                break;
            case BluetoothLog.LEVEL_V:
                android.util.Log.v(tag, msg);
                break;
            case BluetoothLog.LEVEL_E:
